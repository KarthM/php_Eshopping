    ...
    <!--footer-->
    <footer id="footer" class=" text-white py-5" style="background-color:blueviolet";>
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12">
                    <h4 class="font-rubik font-size-20">Mobile</h4>
                    <p class="font-size-14 font-raleway text-white-50">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellendus, deserunt.</p>
                </div>
                <div class="col-lg-4 col-12">
                    ...
                    <form class="form-row">
                        ...
                        <div class="col">
                            <button type="submit" class="btn  mb-2" style="background-color:pink;">Subscribe</button>
                        </div>
                    </form>
                </div>
    ...
    <div class="copyright text-center  text-white py-2"style="background-color:pink";>
        <p class="font-raleway font-size-14 text-dark">&copy; Copyrights 2020 <a href="#" class="text-dark"> <i class="fas fa-star px-2"></i> E-SHOPPEE</a></p>
    </div>
