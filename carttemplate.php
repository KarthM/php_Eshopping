        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12 font-rale  py-3"style="color:darkmagenta";><i class="fas fa-check"></i> Your order is eligible for FREE Delivery.</h6>
                    <div class="border-top py-4">
                        ...
                        <button type="submit" class="btn  mt-3"style="background-color:blueviolet";>Proceed to Buy</button>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
